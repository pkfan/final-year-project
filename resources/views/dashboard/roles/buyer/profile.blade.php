...
<div class="container flex flex-col bg-white shadow-lg">
    ...
    <div class=" w-4/5 mx-auto flex flex-col justify-center items-center">
        ...
        <form action="{{route('buyer.profile.updateInformation')}}" method="post" enctype="multipart/form-data" class="w-full px-4 py-2 ">
            @csrf
            <div class=" my-4">
            ...
            <div class="flex justify-center items-center space-x-4">
                <img class="rounded-lg" src="{{asset(auth()->guard('buyer')->user()->profile_image)}}" alt="" width="200px" height="200px">
                <input type="file" name="profile_image" id="profile_image" value="{{auth()->guard('buyer')->user()->profile_image}}">
                @error('profile_image')
            ...
            <div id="firstName-feild" class=" flex flex-col w-full px-4 py-2 pl-0 ">
                ...
                <input type="text" name="firstName" id="firstName" placeholder="e.g. Muhammad" value="{{auth()->guard('buyer')->user()->first_name}}" class=" @error('firstName') !border-red-500 @enderror placeholder:gray-5 w-full rounded-md p-1 pl-4 border-2 border-gray-5 background-gray-1">
                @error('firstName')
                    <div class="red">{{ $message }}</div>
                @enderror
            </div>
            <!-- end first name field -->
                ...
                <input type="text" name="lastName" id="lastName" required placeholder="e.g. Amir" value="{{auth()->guard('buyer')->user()->last_name}}" class=" @error('lastName') !border-red-500 @enderror placeholder:gray-5 w-full rounded-md p-1 pl-4 border-2 border-gray-5 background-gray-1">
                @error('lastName')
                    <div class="red">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div id="email-feild" class=" flex flex-col w-full px-4 py-2 pl-0 ">
                ...
                <input type="email" name="email" id="email" disabled placeholder="e.g. BC1800400920@vu.edu.pk" value="{{auth()->guard('buyer')->user()->email}}"  class=" @error('email') !border-red-500 @enderror placeholder:gray-5 w-full rounded-md p-1 pl-4 border-2 border-gray-5 background-gray-1">
                @error('email')
                    <div class="red">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div id="address-feild" class=" flex flex-col w-full px-4 py-2 pl-0 ">
                ...
                <input type="address" name="address" value="{{auth()->guard('buyer')->user()->address}}" id="address" required placeholder="e.g. House 10 ghoar chowk serhali road Mustafabad" class=" @error('address') !border-red-500 @enderror placeholder:gray-5 w-full rounded-md p-1 pl-4 border-2 border-gray-5 background-gray-1">
                @error('address')
                    <div class="red">{{ $message }}</div>
                @enderror
            </div>
            <!-- end email field -->
                ...
                <input type="phone" name="phone" value="0{{auth()->guard('buyer')->user()->phone_number}}" id="phone" required placeholder="e.g. 03186323046" class=" @error('phone') !border-red-500 @enderror placeholder:gray-5 w-full rounded-md p-1 pl-4 border-2 border-gray-5 background-gray-1">
                @error('phone')
                    <div class="red">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div id="order-shipping-address" class=" flex flex-col w-full p-4 pl-0 ">
                ...
                <textarea name="about" id="about" cols="30" rows="10" placeholder="please tell us about yourself." class=" w-full rounded-md p-1 pl-4 border-2 border-gray-5 background-gray-1">{{auth()->guard('buyer')->user()->about}}</textarea>
                @error('about')
                    <div class="red">{{ $message }}</div>
                @enderror
            </div>
...
<div class="container flex flex-col mt-6 bg-white shadow-lg">
    <div class=" w-4/5 mx-auto flex flex-col justify-center items-center">
        ...
        <form action="{{route('buyer.profile.updatePassword')}}" method="post" class="w-full px-4 py-2 ">
            @csrf
            <div class=" my-4">
                <h3 class="flex capitalize border-b-4 border-gray-3 opacity-80">
