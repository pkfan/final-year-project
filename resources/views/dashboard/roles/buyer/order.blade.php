...
{{-- filter results  --}}
<form action="{{route('buyer.dashboard.order')}}">
        ...
        <div class="mt-4">
            ...
            <div class=" flex space-x-8 ml-10">
                <div>
                    ...
                    <label class="cursor-pointer" for="orders-all">All Orders</label>
                </div>

                <div>
                    <input type="radio" name="status" id="orders-pending" value='pending'>
                    <label class="cursor-pointer" for="orders-pending">Pending Orders</label>
                </div>

                <div>
                    <input type="radio" name="status" id="orders-processing" value='processing'>
                    <label class="cursor-pointer" for="orders-processing">Processing Orders</label>
                </div>

                <div>
                    <input type="radio" name="status" id="orders-completed" value='completed'>
                    <label class="cursor-pointer" for="orders-completed">Completed Orders</label>
                </div>

                <div>
                    <input type="radio" name="status" id="orders-cancel" value='cancel'>
                    <label class="cursor-pointer" for="orders-cancel">Cancel Orders</label>
                </div>
        ...
        <div class="mt-4">
            ...
            <div class=" flex space-x-8 ml-10">
                <div>
                    ...
                    <label class="cursor-pointer" for="orders-desc">Latest</label>
                </div>

                <div>
                    <input type="radio" name="sort" id="orders-asc" value='asc'>
                    <label class="cursor-pointer" for="orders-asc">Old</label>
                </div>
            </div>
        </div>
        ...
        <div class="mt-4">
            ...
            <div class=" flex space-x-8 ml-10">
                <div>
                    ...
                    <label class="cursor-pointer" for="orders-limit-25">25 records</label>
                </div>

                <div>
                    <input type="radio" name="limit" id="orders-limit-50" value='50'>
                    <label class="cursor-pointer" for="orders-limit-50">50 records</label>
                </div>

                <div>
                    <input type="radio" name="limit" id="orders-limit-75" value='75'>
                    <label class="cursor-pointer" for="orders-limit-75">75 records</label>
                </div>

                <div>
                    <input type="radio" name="limit" id="orders-limit-100" value='100'>
                    <label class="cursor-pointer" for="orders-limit-100">100 records</label>
                </div>
            </div>
        </div>
...
<div class="container flex flex-col bg-white shadow-lg mt-8">
    <h3 class=" text-white bg-black p-2 text-center">Buyer Orders History</h3>
    ...
    <div class=" w-full p-4 flex flex-col justify-center items-center">
        ...
        <table class=" w-full border border-slate-500 my-4 p-4 ">
                    ...
                    <td  class=" border border-slate-500 p-2">
                        ...
                        <div>
                            @if ($order->status == 'processing')
                                <a href="{{route('buyer.dashboard.order.markAsCompleted',['order_id' => $order->order_id])}}" class="bg-green-600 text-center text-xs rounded-lg text-white font-bold block p-2 m-2 hover:bg-green-700">
                                    Mark as Complete
                                </a>
                            @endif
                            ...
                            @if ($order->status == 'pending')
                                <a href="{{route('buyer.dashboard.order.cancel',['order_id' => $order->order_id])}}" class="bg-red-600 text-center text-xs rounded-lg text-white font-bold block p-2 m-2 hover:bg-red-700">
                                    Cancel Order
                                </a>
                            @endif

                            @if ($order->status == 'cancelByBuyer' || $order->status == 'cancelBySupplier')
                                <a href="{{route('buyer.order',['product_id' => $order->product_id])}}" class="bg-yellow-600 text-center text-xs rounded-lg text-white font-bold block p-2 m-2 hover:bg-yellow-700">
                                    Buy Now
                                </a>
                            @endif
            ...
            {{-- <tr>
                ...
                <td  class=" border border-slate-500 p-2">Lorem ipsum dolor sit amet consectetur adipisicing elit.</td>
                <td  class=" border border-slate-500 p-2">Rs.1234657</td>
                <td  class=" border border-slate-500 p-2">5</td>
                <td  class=" border border-slate-500 p-2">1 day ago</td>
                <td  class=" border border-slate-500 p-2">pending</td>
                <td  class=" border border-slate-500 p-2">
                    
                    <div>
                        <a class="bg-green-600 text-center text-xs rounded-lg text-white font-bold block p-2 m-2 hover:bg-green-700" href="#">
                            Mark as Complete
                        </a>

                        <a class="bg-blue-600 text-center text-xs rounded-lg text-white font-bold block p-2 m-2 hover:bg-red-700" href="#">
                            view
                        </a>

                        <a class="bg-red-600 text-center text-xs rounded-lg text-white font-bold block p-2 m-2 hover:bg-red-700" href="#">
                            Cancel Order
                        </a>
