...
class ProfileController extends Controller
{
    public function index(){
        ...
        return view('dashboard.roles.supplier.profile');
    }
    ...
    public function updateInformation(Request $request){
        ...
        if($profileImageFromFrontend){
            ...
            $upLocation = 'assets/images/profile/supplier/';
            ...
            try{
                $profile_image = auth()->guard('supplier')->user()->profile_image;
        ...
        if($imageNameForDatabase){
            $supplierFields['profile_image'] = $imageNameForDatabase;
            
        }


        // updating buyer fields from database
        $isUpdated = Supplier::where('id','=', auth()->guard('supplier')->user()->id)
    ...
    public function updatePassword(Request $request){
        ...
        if($request->currentPassword != auth()->guard('supplier')->user()->password){
        ...
        else if($request->newPassword == auth()->guard('supplier')->user()->password){
       ...
       $isPasswordUpdated = Supplier::where('id','=', auth()->guard('supplier')->user()->id)
        ->update([
